...
export default fp(
  async (fastify, options) => {
    ...
    const config: AppConfig = {
      ...
      azureOpenAiApiModelName:
        process.env.AZURE_OPENAI_API_MODEL || process.env.AZURE_OPENAI_API_DEPLOYMENT_NAME,
      azureOpenAiApiEmbeddingsModelName:
        process.env.AZURE_OPENAI_API_EMBEDDINGS_MODEL || process.env.AZURE_OPENAI_API_EMBEDDINGS_DEPLOYMENT_NAME,
